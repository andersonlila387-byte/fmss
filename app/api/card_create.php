...
try {
    ...
    $stmt = $db->prepare("
        INSERT INTO cards (id, owner_id, title, encrypted_payload, encrypted_data_key, iv)
    ...
    \FMSS\Services\LedgerService::recordAction('CARD_CREATED', $user['id'], $payloadHash, ['card_id' => $id, 'title' => $title]);
