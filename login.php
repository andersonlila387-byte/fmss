...
<head>
    ...
    <title>Sign In | FMSS Vault</title>
    ...
    <style>
        ...
        /* Custom Autofill Styling to prevent white background on saved passwords */
...
<body class="antialiased overflow-x-hidden selection:bg-green-500/30 selection:text-green-50">
    ...
    <div class="flex min-h-screen w-full">
        ...
        <div class="w-full lg:w-1/2 flex flex-col relative z-10 glass-panel">
            ...
            <div class="flex-1 flex items-center justify-center p-6 md:p-8">
                <div class="w-full max-w-sm form-container -mt-16 md:mt-0">
                    ...
                    <div class="mb-8">
                        <h1 class="text-2xl md:text-3xl font-bold mb-2 text-gradient tracking-tight">Access Vault</h1>
                        <p class="text-zinc-400 text-sm font-light">Enter your credentials to decrypt your session.</p>
                    </div>
                    ...
                    <form id="loginForm" class="space-y-4">
                        ...
                        <div class="space-y-1.5 animate-item">
                            <div class="flex justify-between items-center ml-1">
                                <label for="password" class="text-xs font-medium text-zinc-400">Master Password</label>
                                <a href="forgot_password.php" class="text-xs text-green-500 hover:text-green-400 transition-colors">Recover Vault</a>
                            </div>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    ...
                    <div class="mt-8 text-center animate-item">
                        <p class="text-xs text-zinc-500">
                            ...
                            <a href="register.php" class="text-white hover:text-green-400 font-medium transition-colors border-b border-white/20 hover:border-green-400/50 pb-0.5 ml-1">Create one</a>
                        </p>
                    </div>
        ...
        <div class="hidden lg:flex w-1/2 bg-zinc-950 relative items-center justify-center overflow-hidden border-l border-white/5">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-zinc-600 z-0">
                ...
                <span class="text-xs font-mono tracking-widest uppercase">Establishing Secure Connection</span>
            </div>
    ...
    <script type="module">
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            submitBtn.innerHTML = '<i class="ph ph-spinner-gap animate-spin text-xl"></i> Decrypting...';
            ...
            try {
                ...
                if (result.success) {
                    UI.showToast('Access Granted. Redirecting...', 'success');
                    window.location.href = 'app/index.php';
                } else {
                    throw new Error(result.error || 'Login failed.');
                }
            } catch (error) {
                UI.showAlert({ title: 'Authentication Failed', message: error.message, type: 'danger' });
